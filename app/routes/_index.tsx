    ...
    <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center bg-white px-6 text-center">
      ...
      {isSignedIn ? (
        ...
        <SignInButton mode="redirect">
          <button className="mt-12 flex w-full max-w-xs items-center justify-center gap-3 rounded-xl bg-slate-900 px-6 py-4 text-base font-semibold text-white transition-opacity hover:opacity-90">
